...
insert into user_profile_table(permission,username,password,salt) values ('admin','','','');

insert into customer_profile_table(user_id,company_name,org_nr,first_name,last_name,address,phone_nr,email) values (4,'Sporten','550011','Nils','Karlsson','Stockholm','073-123456','nilsk@test.com');
